...
const chekerItem = document.querySelector('.scroller');
...
if (chekerItem) {
    ...
    // First we'll have to set up our event listeners
    // We want to watch for clicks on our scroller
    document.querySelector('.scroller-second').addEventListener('mousedown', function () {
        activeSecond = true;
        // Add our scrolling class so the scroller has full opacity while active
        document.querySelector('.scroller-second').classList.add('scrolling-second');
    });
    // We also want to watch the body for changes to the state,
    // like moving around and releasing the click
    // so let's set up our event listeners
    document.body.addEventListener('mouseup', function () {
        activeSecond = false;
        document.querySelector('.scroller-second').classList.remove('scrolling-second');
    });
    document.body.addEventListener('mouseleave', function () {
        activeSecond = false;
        document.querySelector('.scroller-second').classList.remove('scrolling-second');
    ...
    // Let's figure out where their mouse is at
    document.body.addEventListener('mousemove', function (e) {
        if (!activeSecond) return;
        // Their mouse is here...
        let x = e.pageX;
        // but we want it relative to our wrapper
        x -= document.querySelector('.wrapper-second').getBoundingClientRect().left;
        // Okay let's change our state
        scrollItSecond(x);
    });

    // Let's use this function
    function scrollItSecond(x) {
        let transform = Math.max(0, (Math.min(x, document.querySelector('.wrapper-second').offsetWidth)));
        document.querySelector('.after-second').style.width = transform + "px";
        document.querySelector('.scroller-second').style.left = transform - 25 + "px";
    }
    ...
    // And finally let's repeat the process for touch events
    // first our middle scroller...
    document.querySelector('.scroller-second').addEventListener('touchstart', function () {
        activeSecond = true;
        document.querySelector('.scroller-second').classList.add('scrolling-second');
    });
    document.body.addEventListener('touchend', function () {
    ...
    // First we'll have to set up our event listeners
    // We want to watch for clicks on our scroller
    document.querySelector('.scroller-third').addEventListener('mousedown', function () {
        activeThird = true;
        // Add our scrolling class so the scroller has full opacity while active
        document.querySelector('.scroller-third').classList.add('scrolling-third');
    });
    // We also want to watch the body for changes to the state,
    // like moving around and releasing the click
    // so let's set up our event listeners
    document.body.addEventListener('mouseup', function () {
        activeThird = false;
        document.querySelector('.scroller-third').classList.remove('scrolling-third');
    });
    document.body.addEventListener('mouseleave', function () {
        activeThird = false;
        document.querySelector('.scroller-third').classList.remove('scrolling-third');
    ...
    // Let's figure out where their mouse is at
    document.body.addEventListener('mousemove', function (e) {
        if (!activeThird) return;
        // Their mouse is here...
        let x = e.pageX;
        // but we want it relative to our wrapper
        x -= document.querySelector('.wrapper-third').getBoundingClientRect().left;
        // Okay let's change our state
        scrollItThird(x);
    });

    // Let's use this function
    function scrollItThird(x) {
        let transform = Math.max(0, (Math.min(x, document.querySelector('.wrapper-third').offsetWidth)));
        document.querySelector('.after-third').style.width = transform + "px";
        document.querySelector('.scroller-third').style.left = transform - 25 + "px";
    }
    ...
    // And finally let's repeat the process for touch events
    // first our middle scroller...
    document.querySelector('.scroller-third').addEventListener('touchstart', function () {
        activeThird = true;
        document.querySelector('.scroller-third').classList.add('scrolling-third');
    });
    document.body.addEventListener('touchend', function () {
