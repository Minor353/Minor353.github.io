...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _popupForm = __webpack_require__(13);
	
	var _popupForm2 = _interopRequireDefault(_popupForm);
	
	var _aboutMain = __webpack_require__(8);
	
	var _aboutMain2 = _interopRequireDefault(_aboutMain);
	
	var _prevSection = __webpack_require__(9);
	
	var _prevSection2 = _interopRequireDefault(_prevSection);
	
	var _share = __webpack_require__(10);
	
	var _share2 = _interopRequireDefault(_share);
	
	var _tabsTable = __webpack_require__(11);
	
	var _tabsTable2 = _interopRequireDefault(_tabsTable);
	...
	(0, _popupForm2.default)();
	
	(0, _aboutMain2.default)();
	
	(0, _prevSection2.default)();
	
	(0, _share2.default)();
	
	(0, _tabsTable2.default)();
...
/***/ (function(module, exports) {
	...
	function reviews() {
		var headerPanel = document.querySelector('.header');
		var headerTriger = document.querySelector('body');
		var headerTrigerTop = headerTriger.getBoundingClientRect().top + window.pageYOffset;
...
/***/ (function(module, exports) {
	...
	function reviews() {
		...
		var navList = document.querySelector('.nav--header .nav_list');
...
/***/ (function(module, exports) {
	...
	exports.default = reviews;
	function reviews() {
		var tabsWrap = document.querySelector('.tabs-table');
	
		if (tabsWrap) {
			(function () {
				var tabsBtn = document.querySelectorAll('.tabs-table_tabs-item');
				var tabsContent = document.querySelectorAll('.tabs-table_content-item');
				...
				var _loop = function _loop(i) {
					tabsBtn[i].addEventListener('click', function () {
						for (var _i = 0; _i < tabsBtn.length; _i++) {
							tabsContent[_i].classList.remove('tabs-table_content-item--active');
							tabsBtn[_i].classList.remove('tabs-table_tabs-item--active');
						};
...
/***/ (function(module, exports) {
	...
	function reviews() {
		...
		var popupFormBtns = document.querySelectorAll('.js-form-popup');
		var popupFormCross = document.querySelector('.popup-form_content-cross');
	
		if (popupFormBtns[0]) {
			var submitPopupForm = function submitPopupForm(e) {
				e.preventDefault();
			...
			var setCursorPosition = function setCursorPosition(pos, e) {
				e.focus();
			...
			for (var i = 0; i < popupFormBtns.length; i++) {
			...
			window.addEventListener("DOMContentLoaded", function () {
				...
				for (var _i = 0; _i < input.length; _i++) {
					input[_i].addEventListener("input", mask, false);
					input[_i].focus();
					setCursorPosition(3, input[_i]);
				};
			});
			/***********************************/
		};
