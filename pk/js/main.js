...
$document.ready(function () {
  ...
  $(window).on("wheel", function(){
    if($("#section0").is(".active")) {
      $(".header-bar-main").addClass("header-bar-main--active");
    } else {
      $(".header-bar-main").removeClass("header-bar-main--active");
    }
  });
